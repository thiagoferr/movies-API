...
const movieCrewController = {
  ...
  async findAll(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const newList = JSON.parse(list).map((x: any) => x.movie_crew)
  ...
  async findById(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const newList =  JSON.parse(list).movie_crew
      
      if (list) return res.json(newList)
...
export default movieCrewController
